  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <a href="home.php" class="navbar-brand"><i class="icon-home"></i> Feed</a>
    </div>
    <nav class="collapse navbar-collapse" role="navigation">
      <ul class="nav navbar-nav">
        ...
        <li><a href="search.php"><i class="icon-group"></i> People</a></li>
        <li><a href="friends.php"><i class="icon-group"></i> Friends</a></li>
		<li><a href="message.php"><i class="icon-group"></i> Message</a></li>
        <li><a href="sessions_form.html"><i class="icon-camera"></i> Session</a></li>
        <li>
